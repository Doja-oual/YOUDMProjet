...
// Créer une instance de CourseRepository
$courseRepository = new CoursRepository();

// Récupérer la liste des cours avec les informations de l'enseignant
$courses = $courseRepository->getCoursesWithTeacherInfo();

// Vérifier s'il y a des erreurs
if ($courses === false) {
    die("Une erreur s'est produite lors de la récupération des cours.");
}
?>
                    ...
                    <?php foreach ($courses as $course) : ?>
                        <div class="col-md-4">
                            <div class="course-card">
                                <h3><?= htmlspecialchars($course['cours_titre']) ?></h3>
                                <p><strong>Date d'inscription :</strong> <?= htmlspecialchars($course['cours_date_creation']) ?></p>
