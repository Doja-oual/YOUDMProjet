...
if ($students === false) {
    die("Une erreur s'est produite lors de la récupération des étudiants.");
}
?>
                    ...
                    <?php foreach ($students as $student) : ?>
                        <div class="col-md-4">
                            <div class="student-card">
                                ...
                                <p><strong>Date d'inscription :</strong> <?= htmlspecialchars($student['date_inscription']) ?></p>
                                <p><strong>Statut :</strong> <?= htmlspecialchars($student['statut_id'] == User::STATUS_ACTIVE ? 'Actif' : 'Inactif') ?></p>
                                <a href="student_details.php?id=<?= htmlspecialchars($student['id']) ?>" class="btn btn-primary">
